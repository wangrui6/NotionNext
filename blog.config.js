...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || "Hello, I'm a builder, a worker, a hustler - welcome to my blog🎉",

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'raygorous👻', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'a man with a bit of everything🔥', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://raygorous.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'career advancement in AI, sailing, MBTI and Tech Industry, tech industry insights, ai startup advice, Leading a Machine Learning Team, Interview Preparation for Tech Industry', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'ray@raygorous.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || 'https://twitter.com/ruiwangr', // 你的twitter个人主页
